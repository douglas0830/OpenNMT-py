...
class LMRNNDecoderBase(nn.Module):
    """
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
        ...
        super(LMRNNDecoderBase, self).__init__()
        ...
        self.attn = None#onmt.modules.GlobalAttention(
...
class LMStdRNNDecoder(LMRNNDecoderBase):
    """
...
class LMInputFeedRNNDecoder(LMRNNDecoderBase):
    """
